...
import {
  AccountInformation, AreaInformations, AttentionRecord, CityInformations, CompanyInformation, DeleteAccountsAccountidQueryParams, DeliveryRecord, DirectionTags, EducationExperience, FilterInformation, GarnerRecord, GetAreaInformationsQueryParams, GetCompanyinfosCompanyinfoidDeliveryrecordsQueryParams, GetCompanyinfosCompanyinfoidPositioninfosQueryParams, GetCompanyinfosPositioninfosQueryParams, GetDirectiontagsQueryParams, GetUserinfosQueryParams, GetUserinfosUserinfoidAttentionrecordsQueryParams,
  GetUserinfosUserinfoidDeliveryrecordsQueryParams, GetUserinfosUserinfoidEduexperiencesQueryParams, GetUserinfosUserinfoidGarnerrecordsQueryParams, GetUserinfosUserinfoidInspectionrecordsQueryParams, GetUserinfosUserinfoidJobexpectationsQueryParams, GetUserinfosUserinfoidProjectexperiencesQueryParams,
  GetUserinfosUserinfoidWorkexperiencesQueryParams, GetVerificationCodeQueryParams, HRInformation, InspectionRecord, JobExpectation, MessageRecord, PositionInformation, PositionTypes,
  ProjectExperience, UserInformation, WorkExperience
} from "./types";
...
export const getUserinfosUserinfoidAttentionrecords = (
   ...
   */
  userinfoid: string,
  queryParams: GetUserinfosUserinfoidAttentionrecordsQueryParams,
  configOverride?: AxiosRequestConfig
): Promise<
  SwaggerResponse<{
    /**
...
export const getUserinfosUserinfoidEduexperiences = (
   ...
   */
  userinfoid: string,
  queryParams: GetUserinfosUserinfoidEduexperiencesQueryParams,
  configOverride?: AxiosRequestConfig
): Promise<
  SwaggerResponse<{
    /**
...
export const getUserinfosUserinfoidGarnerrecords = (
   ...
   */
  userinfoid: string,
  queryParams: GetUserinfosUserinfoidGarnerrecordsQueryParams,
  configOverride?: AxiosRequestConfig
): Promise<
  SwaggerResponse<{
    /**
...
export const getUserinfosUserinfoidInspectionrecords = (
   ...
   */
  userinfoid: string,
  queryParams: GetUserinfosUserinfoidInspectionrecordsQueryParams,
  configOverride?: AxiosRequestConfig
): Promise<
  SwaggerResponse<{
    /**
...
export const getUserinfosUserinfoidJobexpectations = (
   ...
   */
  userinfoid: string,
  queryParams: GetUserinfosUserinfoidJobexpectationsQueryParams,
  configOverride?: AxiosRequestConfig
): Promise<
  SwaggerResponse<{
    /**
...
export const getUserinfosUserinfoidProjectexperiences = (
   ...
   */
  userinfoid: string,
  queryParams: GetUserinfosUserinfoidProjectexperiencesQueryParams,
  configOverride?: AxiosRequestConfig
): Promise<
  SwaggerResponse<{
    /**
...
export const getUserinfosUserinfoidWorkexperiences = (
   ...
   */
  userinfoid: string,
  queryParams: GetUserinfosUserinfoidWorkexperiencesQueryParams,
  configOverride?: AxiosRequestConfig
): Promise<
  SwaggerResponse<{
    /**
